...
(/** @lends <global> */function( $ ) {
	...
	function _fnAddOptionsHtml ( oSettings )
	{
		...
		var featureNode, cOption, nNewNode, cPróximo, sAttr, j;
		for ( var i=0 ; i<aDom.length ; i++ )
		{
			...
			if ( cOption == '<' )
			{
				...
				cPróximo = aDom[i+1];
				if ( cPróximo == "'" || cPróximo == '"' )
				{
					sAttr = "";
					j = 2;
					while ( aDom[i+j] != cPróximo )
					{
						sAttr += aDom[i+j];
						j++;
					}
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var previousSearch = settings.oAnteriorSearch;
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Listando _START_ de _END_ de _TOTAL_ entradas",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Listando 0 de 0 de 0 entradas",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtrando a partir de  _MAX_ total )",
		 ...
		 * * `full_numbers` - 'First', 'Anterior', 'Próximo' and 'Last' buttons, plus
		 *   page numbers
		 *  
